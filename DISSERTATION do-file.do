...
keep case_id HHID hh_u0a hh_u01b
tab hh_u0a, gen (shock)
gen climatic_shocks = ( shock1==1| shock2==1| shock3==1| shock23==1| shock22==1 )
drop shock1 shock2 shock3 shock23 shock22
gen agric_shocks = ( shock4==1| shock5==1| shock6==1| shock7==1)
drop shock4 shock5 shock6 shock7
gen financial_shocks = ( shock8==1| shock9==1| shock10==1| shock11==1| shock12==1| shock13==1| shock16==1| shock19==1 )
drop shock8 shock9 shock10 shock11 shock12 shock13 shock16 shock19
gen hh_shocks = ( shock14==1| shock15==1| shock17==1| shock18==1| shock20==1)
drop shock14 shock15 shock17 shock18 shock20 shock21 hh_u0a hh_u01b
* Generate the categorical shock variable
gen shock_category = 0 if (climatic_shocks == 0 & agric_shocks == 0 & financial_shocks == 0 & hh_shocks == 0)
* Assign categories for single shocks
replace shock_category = 1 if (climatic_shocks == 1 & agric_shocks == 0 & financial_shocks == 0 & hh_shocks == 0)
replace shock_category = 2 if (agric_shocks == 1 & climatic_shocks == 0 & financial_shocks == 0 & hh_shocks == 0)
replace shock_category = 3 if (financial_shocks == 1 & climatic_shocks == 0 & agric_shocks == 0 & hh_shocks == 0)
replace shock_category = 4 if (hh_shocks == 1 & climatic_shocks == 0 & agric_shocks == 0 & financial_shocks == 0)
* Assign category for multiple shocks (2+ shocks)
replace shock_category = 5 if (climatic_shocks + agric_shocks + financial_shocks + hh_shocks >= 2) & !missing(shock_category)
label define shock_cat_lbl 0 "No shock" 1 "Climatic only" 2 "Agricultural only" 3 "Financial only" 4 "HH only" 5 "Multiple shocks"
label values shock_category shock_cat_lbl
tab shock_category, missing
codebook shock_category
drop climatic_shocks agric_shocks financial_shocks hh_shocks

sort case_id HHID 
* Keep only the first observation for each household
bysort HHID : keep if _n == 1
* Then run your tabulation again
tab shock_category
...
***************************************************************
* Regression Analysis *
ologit i.fcs_category Access_to_credit Assistance Safety_net hh_head education_level Location Shocks Agricultural_Asset_Ownership
